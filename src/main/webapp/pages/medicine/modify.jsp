			...
			<div class="row mt">
				<div class="col-lg-12">
					<div class="form-panel">
			      	  <h4 class="mb"><i class="fa fa-angle-right"></i>请输入要修改的药物信息</h4>
			              <form enctype="multipart/form-data" class="form-horizontal tasi-form" method="post" action="update.do">
							  <div class="form-group has-success">
							      <label class="col-sm-2 control-label col-lg-2" for="id">药物编号</label>
							      <div class="col-lg-10">
